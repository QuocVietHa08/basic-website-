        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div class="mt-8 overflow-hidden">
                <div class="grid grid-cols-1 md:grid-cols-2">
                    ...
                    <form class="p-6 flex flex-col justify-center" method="POST" action="submit">
                        @csrf
                        ...
                        <div class="flex flex-col mt-2">
                            ...
                            <input type="message" name="message" id="Message" placeholder="Message" class="w-100 mt-2 py-3 px-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-400 dark:border-gray-700 text-gray-800 font-semibold focus:border-indigo-500 focus:outline-none">
                        </div>
